...
export default function ReturnUI({ setPowerOn, powerOn, setReturn_power, onClick }) {
    ...
    return (
        ...
        >
            ...
            {(powerOn && currentCamera !== "demoMenu") && (
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 541.87 541.87"  >
