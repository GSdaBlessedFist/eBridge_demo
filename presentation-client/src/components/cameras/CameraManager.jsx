    ...
    useEffect(() => {
        const off = on((event) => {
            ...
            if (event.type === "POWER_ON") {
                useCameraStore.getState().setCamera("demoMenu")
            }

            if (event.type === "RETURN") {
                useCameraStore.setState({
                    currentCamera: "demoMenu",
                    resetConfigAnimation: true
                })
                emit("REVERSE_CONFIG_PANEL")
            }
            ...
            if (event.type === "GOTO_CONFIG") {
                useCameraStore.getState().setCamera("config")
            }
